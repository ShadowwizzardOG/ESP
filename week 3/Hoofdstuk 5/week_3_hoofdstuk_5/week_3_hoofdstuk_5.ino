...
#include "time.h"
// LED is active high
#define GPIO_LED_SEM 19
#define GPIO_BUTTONL 4
#define GPIO_BUTTONR 23
#define DEBOUNCE_TIME 30 // the debounce time in millisecond, increase this time if
...
int lastFlickerableState = LOW; // the previous flickerable state from the input
...
{
   printf("There is already a task executed\r\n");
   }
}
//
// Initialization:
